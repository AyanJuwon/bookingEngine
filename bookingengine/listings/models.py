...
class BookedListing(models.Model):
    booking_info = models.OneToOneField(BookingInfo,on_delete=models.CASCADE)
    ...
    def __str__(self) -> str:
        return f"{self.booking_info} reserved from {self.booking_start_date} to {self.booking_end_date}"
